...
Before contributing, make sure you have the project set up locally. See the [README](./README.md) for installation instructions.
...
<!-- Describe the coding style, linter configuration, or formatting rules for this project. -->

This project follows [describe your style guide or linter here]. Before submitting, please ensure your code is formatted accordingly.
